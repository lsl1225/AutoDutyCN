...
namespace AutoDuty.Helpers
{
    ...
    internal static unsafe class InventoryHelper
    {
        ...
        internal static bool CanRepair() => CanRepair(Configuration.Loop.Pre.AutoRepairPct);// && (!Plugin.Configuration.AutoRepairSelf || CanRepairItem(LowestEquippedItem().GetItemId()));
