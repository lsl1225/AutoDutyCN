    ...
    internal static class SummoningBellHelper
    {
        ...
        private static Vector3 SummoningBellVector3S(uint territoryType) =>
            territoryType switch
            {
                ...
                131 => new Vector3(148.91272f,   3.982544f,     -44.205383f),
                419 => new Vector3(-151.1712f,   -12.64978f,    -11.7647705f),
                635 => new Vector3(-57.63336f,   -0.015319824f, 49.30188f),
                628 => new Vector3(19.394226f,   4.043579f,     53.025024f),
                759 => new Vector3(60.56299f,    -0.015319824f, -3.982666f),
                819 => new Vector3(-69.840576f,  -7.7058716f,   123.49121f),
                820 => new Vector3(7.1869507f,   83.17688f,     31.448853f),
                962 => new Vector3(42.09961f,    2.517002f,     -39.414062f),
                963 => new Vector3(26.749023f,   -0.015319824f, -53.696533f),
                1185 => new Vector3(18.57019f,   -14.023071f,   120.408936f),
        ...
        {
            switch (Configuration.Loop.Between.PreferredSummoningBellEnum)
            {
                ...
                default:
                    GotoHelper.Invoke((uint)Configuration.Loop.Between.PreferredSummoningBellEnum, SummoningBellVector3S((uint)summoningBellLocation), 0.25f, 4);
                    break;
            }
        }
    }
